@echo off
REM ========================================================================
REM GCN Stage Profiling - Full Test (CPU + GPU + NPU)
REM ========================================================================
REM
REM GCN 6-Stage Decomposition:
REM   Stage 1: COMPUTE_NORM - CPU/GPU only (scatter - NPU skip)
REM   Stage 2: GATHER       - CPU/GPU/NPU
REM   Stage 3: MESSAGE      - CPU/GPU/NPU
REM   Stage 4: REDUCE_SUM   - CPU/GPU only (scatter - NPU skip)
REM   Stage 5: TRANSFORM    - CPU/GPU/NPU
REM   Stage 6: ACTIVATE     - CPU/GPU/NPU
REM
REM Workflow:
...
REM ========================================================================
echo ========================================================================
echo PHASE 1: Exporting All GCN Models (CPU + GPU + NPU)
echo ========================================================================
echo.

REM Check if CPU/GPU models exist
if not exist "gcn_exported_models\stage2_cpu.xml" (
...
if not exist "gcn_exported_models\stage2_npu_n5000_e50000.xml" (
...
echo.
echo Phase 1 complete: All GCN models ready.
echo.
...
REM ========================================================================
echo ========================================================================
echo PHASE 2: Measuring GCN CPU Latencies (All 6 Stages)
echo ========================================================================
echo.
...
REM ========================================================================
echo ========================================================================
echo PHASE 3: Measuring GCN GPU Latencies (All 6 Stages)
echo ========================================================================
echo.
...
REM ========================================================================
echo ========================================================================
echo PHASE 4: Measuring GCN NPU Latencies (Isolated Processes)
echo ========================================================================
echo.
...
echo Skipping stages 1 and 4 (scatter operations not supported on NPU).
echo.

REM Define node sizes and NPU-supported stages
...
echo Total NPU tests: %TOTAL_TESTS% (8 node sizes x 4 stages)
echo.
...
REM ========================================================================
echo ========================================================================
echo PHASE 5: Merging GCN Results and Analyzing
echo ========================================================================
echo.
