@echo off
REM ========================================================================
REM GAT Stage Profiling - Full Test (CPU + GPU + NPU)
REM ========================================================================
REM
REM GAT 7-Stage Decomposition:
REM   Stage 1: LINEAR           - CPU/GPU/NPU
REM   Stage 2: GATHER_BOTH      - CPU/GPU/NPU
REM   Stage 3: ATTENTION_SCORE  - CPU/GPU/NPU
REM   Stage 4: ATTENTION_SOFTMAX - CPU/GPU only (scatter - NPU skip)
REM   Stage 5: MESSAGE_WEIGHTED - CPU/GPU/NPU
REM   Stage 6: REDUCE_SUM       - CPU/GPU only (scatter - NPU skip)
REM   Stage 7: ACTIVATE         - CPU/GPU/NPU
REM
REM Workflow:
...
REM ========================================================================
echo ========================================================================
echo PHASE 1: Exporting All GAT Models (CPU + GPU + NPU)
echo ========================================================================
echo.
...
if not exist "gat_exported_models\stage1_npu_n5000_e50000.xml" (
...
echo.
echo Phase 1 complete: All GAT models ready.
echo.
...
REM ========================================================================
echo ========================================================================
echo PHASE 2: Measuring GAT CPU Latencies (All 7 Stages)
echo ========================================================================
echo.
...
REM ========================================================================
echo ========================================================================
echo PHASE 3: Measuring GAT GPU Latencies (All 7 Stages)
echo ========================================================================
echo.
...
REM ========================================================================
echo ========================================================================
echo PHASE 4: Measuring GAT NPU Latencies (Isolated Processes)
echo ========================================================================
echo.
...
echo Skipping stages 4 and 6 (scatter operations not supported on NPU).
echo.
...
REM ========================================================================
echo ========================================================================
echo PHASE 5: Merging GAT Results and Analyzing
echo ========================================================================
echo.
