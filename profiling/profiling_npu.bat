...
REM ========================================================================
REM Step 1: Export NPU static models (auto-skip existing files)
REM ========================================================================

echo.
echo ================================================================
echo [Step 1/4] Exporting SAGE NPU static models (auto-skip existing)
echo ================================================================
python profile_stages.py --export-npu

echo.
echo ================================================================
echo [Step 2/4] Exporting GAT NPU static models (auto-skip existing)
echo ================================================================
python gat_profile_stages.py --export-npu

REM ========================================================================
REM Step 3: SAGE NPU - Stage 1, 5, 6, 7 (4 stages x 8 sizes = 32)
REM ========================================================================

echo.
echo ================================================================
echo [Step 3/4] SAGE NPU Profiling (Stage 1, 5, 6, 7)
echo ================================================================
...
REM ========================================================================
REM Step 4: GAT NPU - Stage 3, 5 (2 stages x 8 sizes = 16)
REM ========================================================================

echo.
echo ================================================================
echo [Step 4/4] GAT NPU Profiling (Stage 3, 5)
echo ================================================================
