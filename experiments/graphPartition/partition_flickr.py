"""
METIS-based Graph Partitioner for Flickr Dataset

This script partitions the Flickr dataset using METIS min-cut algorithm
...
class FlickrPartitioner:
    """
    METIS-based partitioner for Flickr dataset.
...
def main():
    ...
    # Save results
    output_path = output_dir / 'partition_results.json'
